export const personalInfo = {
  ...
  tagline:
    "I build scalable UI systems and developer tools with a strong focus on usability and clean architecture.",
...
export const featuredProjects: Project[] = [
  {
    ...
    tagline:
      "Interactive visualization tool for component flows in modern web apps",
    description:
      "A developer tool built with TypeScript and React that enables interactive visualization, editing, and deployment of component flows in modern web applications.",
    problem:
      "Developers struggle to visualize and document complex component hierarchies and data flows in large React applications, leading to poor onboarding and maintainability issues.",
    solution:
      "Built an interactive platform featuring real-time component flow visualization, live code editing, and integrated deployment workflows - streamlining both development and documentation processes.",
    role: [
    ...
    techStack: [
      {
        name: "TypeScript",
        reason: "Type safety for complex flow data structures",
      },
    ...
    outcome:
      "Successfully deployed as an open-source tool. Demonstrates deep understanding of React internals, state management patterns, and developer tooling.",
  ...
  },
  {
    ...
    description:
      "React and TypeScript based weather tracking application with country-based tracking and dynamic UI themes that change based on weather conditions.",
    problem:
      "Existing weather apps offer static, one-size-fits-all interfaces that don't adapt to the actual weather conditions, reducing user engagement and contextual awareness.",
    solution:
      "Built a weather tracking system that dynamically changes its entire UI theme based on real-time weather data - sunny, rainy, cloudy conditions each trigger unique visual experiences.",
    role: [
    ...
    outcome:
      "Fully deployed application showcasing API integration skills, dynamic UI systems, and data-driven frontend development.",
  ...
  },
  {
    ...
    description:
      "Python-based daily to-do tracking Telegram bot that manages daily activities and tasks through an intuitive conversational interface.",
    problem:
      "Professionals need a frictionless way to track daily tasks without switching to dedicated apps - something embedded in tools they already use daily.",
    solution:
      "Developed a Telegram bot that handles task creation, tracking, and completion through natural conversational commands, integrating directly into users' existing workflow.",
    role: [
    ...
    techStack: [
      { name: "Python", reason: "Rapid development & rich bot libraries" },
      {
        ...
        reason: "Wide user base, reliable messaging",
      },
    ...
    outcome:
      "Deployed and actively used for personal productivity. Demonstrates backend development, API integration, and system-level thinking.",
  ...
  },
  {
    ...
    description:
      "A comprehensive leave management system built with C# using OOP concepts. Manages employees' roster time and their annual, casual, and short leaves.",
    problem:
      "Manual leave tracking in organizations leads to scheduling conflicts, payroll errors, and poor visibility into team availability.",
    solution:
      "Built an enterprise LMS with role-based access, automated leave balance calculations, roster management, and reporting dashboards.",
    role: [
    ...
    outcome:
      "Completed as a major academic project. Demonstrates system-level thinking, database design, and enterprise software development.",
...
export const otherProjects = [
  ...
  {
    title: "XCoders Website",
    tech: "ReactJS, Material UI, Vite",
    date: "May 2025 - Jun 2025",
  },
  {
    title: "Direct Message Delay",
    tech: "ReactJS, Material UI, TypeScript, Vite",
    date: "Aug 2025 - Jun 2025",
  },
  {
  ...
  {
    title: "OpenClaude-Portable",
    tech: "HTML / Portable AI tooling",
    date: "May 2025",
  },
  {
    title: "Darkstar-Labs-Website",
  ...
  {
    title: "AI-Chat-Data-Insight-App",
    tech: "JavaScript / Data Insights",
    date: "Feb 2025",
  },
  {
    title: "smart-todo-app",
    tech: "TypeScript / Productivity",
    date: "Feb 2025",
  },
  {
    title: "Telegram_ToDo_Bot",
    tech: "Python / Bot",
    date: "Jun 2025",
  },
  {
    title: "EduTrackAI",
    tech: "TypeScript / Education",
    date: "Nov 2025",
  },
  {
    title: "AI_ChatBot",
...
export const dataExperience = [
  {
    ...
    desc: "Created interactive data visualizations and business intelligence reports",
  },
  {
    title: "Python Analytics",
    desc: "Data manipulation and analysis using Pandas & NumPy libraries",
  },
  {
    title: "SQL Queries",
    desc: "Complex database queries, optimization, and data extraction",
  },
  {
    title: "Data-Driven UI",
    desc: "Built frontend interfaces that dynamically respond to data patterns",
  },
];
