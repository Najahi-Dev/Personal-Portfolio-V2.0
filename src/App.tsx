    ...
    <>
      ...
      <div
        className={`relative min-h-screen transition-colors duration-500 ${
          isLight ? "bg-[#f5f6fa] text-dark-900" : "bg-dark-950 text-dark-100"
        }`}
      >
        ...
        <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
          ...
          <div
            ...
            style={{
              ...
              left: "15%",
              background:
                "radial-gradient(circle, rgba(76,110,245,0.06) 0%, transparent 70%)",
          ...
          <div
            ...
            style={{
              ...
              right: "10%",
              background:
                "radial-gradient(circle, rgba(245,159,0,0.04) 0%, transparent 70%)",
          ...
          <div
            ...
            style={{
              ...
              left: "30%",
              background:
                "radial-gradient(circle, rgba(100,60,220,0.04) 0%, transparent 70%)",
