...
const PHONE = "94750538620";
const GREETING = encodeURIComponent(
  "Hi Ahmadh! I visited your portfolio and would love to connect. Let's chat!",
);
      ...
      <AnimatePresence>
        {tooltip && (
          <motion.div
            ...
            className="rounded-xl bg-white px-4 py-2.5 text-sm font-medium text-gray-800 shadow-lg shadow-black/10 border border-gray-100"
          >
